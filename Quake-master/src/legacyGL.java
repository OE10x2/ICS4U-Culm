...
public class legacyGL{
	...
	public void run() throws Exception{
		...
		Scanner maze = new Scanner(new File("Quake-master/Resource/Models/Map.txt"));
		int counter = 0;
		...
		charTex = new Texture("Quake-master/Resource/Images/text.png");
		charTex.setPixel(0);
		mapTex = new Texture("Quake-master/Resource/Images/Wall.jpg");
		enemyTex = new Texture("Quake-master/Resource/Images/Enemy1.png");
		gunTex = new Texture("Quake-master/Resource/Images/Pistol.png");
		medTex = new Texture("Quake-master/Resource/Images/Medkit.png");
		ammoTex = new Texture("Quake-master/Resource/Images/Ammo.jpg");
	...
	private void loop() throws Exception{
		...
		float kitScale = 0.8f;
		map = new MeshObject("Quake-master/Resource/Models/Map.obj");
		map.setTexture(mapTex);
		gun = new MeshObject("Quake-master/Resource/Models/M9A1.obj");
		gun.setTexture(gunTex);
		gun.scale(new Point3f(gunScale, gunScale, gunScale));
		medKit = new MeshObject("Quake-master/Resource/Models/MedKit.obj");
		medKit.scale(new Point3f(kitScale, kitScale, kitScale));
		medKit.setTexture(medTex);
		ammoPack = new MeshObject("Quake-master/Resource/Models/Ammo.obj");
		ammoPack.setTexture(ammoTex);
		String path2 = "Quake-master/Resource/Models/Move_000";
